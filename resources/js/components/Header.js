        ...
        <div className="main-wrapper slide-nav">
                    ...
                    <div className="header-right">
                        ...
                        <div style={{textAlign: 'center'}}>
                            <ul className="nav navbar-nav navbar-right user-menu pull-right">
                                <div className="dropdown">
                                    <a className="dropdown-toggle" href="#" role="button" id="profileLinkDropdown"
                                    data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        <span><i className="far fa-user"></i></span> Admin
                                    </a>

                                    <div className="dropdown-menu" aria-labelledby="profileLinkDropdown">
                                        <a className="dropdown-item logOut" href="#">Profile</a>
                                        <a className="dropdown-item logOut" href="#">Password Change</a>
                                        <a className="dropdown-item logOut" onClick={()=>userLogout(props)} href="">Logout</a>
                                    </div>
                                </div>
                        ...
                        <div className="dropdown mobile-user-menu pull-right">
                            ...
                            <ul className="dropdown-menu pull-right">
                                <li><a className="logOut" onClick={()=>userLogout(props)}>Logout</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div className="sidebar-inner slimscroll">
                <div id="sidebar-menu" className="sidebar-menu">
                    <ul>
                        <li>
                            <a href=""><i className="icofont-speed-meter"></i> Dashboard</a>
                        </li>
                            ...
                            <ul className="list-unstyled" style={{display:"none"}}>
                                <li className="">
                                        <Link to="/dbBackup/manage-warehouse">Manage WareHouse</Link>
                                </li>
                                <li className="">
                                    <a data-id="0"
